        ...
        <CardContent className="grid p-0 md:grid-cols-2 w-3/5">
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <Button
                type="submit"
                className="w-full bg-blue-950 text-white dark:bg-white dark:text-black"
              >
                Login
              </Button>
          ...
          <div className="bg-muted relative hidden md:block duration-100 hover:brightness-107">
            <img
              src="/perfil.png"
              alt="Image"
              className="absolute inset-0 h-full w-full bg-none object-cover rounded-2xl"
            />
            <Pointer>
              <div className="text-5xl select-none pointer-events-none">❤️</div>
            </Pointer>
